...
import requests
import unidecode
from Cinema.UnitScrap import UnitScrapCinema
...
def ScrapCinema(url,day,HEADERS = HeadersDefault):
    ...
    ref = pd.read_csv('Cinema\ListeCinema.csv', sep = ';')          #Merging with an opendata list to get adress
